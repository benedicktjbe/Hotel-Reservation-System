...
public class HotelReservationSystem {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            do {
                ...
                String temploopchoice = sc.nextLine();
    ...
    public static void checkRoomAvailability(){
        ...
        do {
            System.out.print("Enter your choice here: ");
            String tempcheckRoom = sc.nextLine();
        ...
        switch (checkRoom) {
            case 'A' -> checkStandardRoom(standardRoom);
            case 'B' -> checkDeluxeRoom(deluxeRoom);
            case 'C' -> checkSuiteRoom(suiteRoom);
        }
    }

    public static void checkStandardRoom(String[][] standardRoom){
    ...
    public static void checkDeluxeRoom(String[][] deluxeRoom){
        for (int rows = 0; rows < deluxeRoom.length; rows++) {
            for (int col = 0; col < deluxeRoom[rows].length; col++) {
                System.out.print(deluxeRoom[rows][col] + "\t");
            }
            System.out.println();
        }
    }

    public static void checkSuiteRoom(String[][] suiteRoom){
        for (int rows = 0; rows < suiteRoom.length; rows++) {
            for (int col = 0; col < suiteRoom[rows].length; col++) {
                System.out.print(suiteRoom[rows][col] + "\t");
            }
            System.out.println();
        }
    }
